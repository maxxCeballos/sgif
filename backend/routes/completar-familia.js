...
const { vDniAlumno, vAsociarPadre, vPadreNuevo,
     vPadreRol, vAsociarHermano, vHermano, vHermanoRol } = require('../middlewares/validaRequests');
...
router.get('/completar-familia/alumno/:dni', vDniAlumno, asyncHandler(async (req, res) => {
...
router.put('/completar-familia/asociar-padre/:dniPadre', vAsociarPadre, asyncHandler(async (req, res) => {
 ...
 */
router.get('/completar-familia/persona/:dniPersona', asyncHandler(async (req, res) => {
...
router.put('/completar-familia/asociar-hermano/:dniHermano', vAsociarHermano, asyncHandler(async (req, res) => {
